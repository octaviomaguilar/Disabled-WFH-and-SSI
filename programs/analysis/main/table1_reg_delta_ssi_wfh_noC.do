...
merge 1:1 occ2 using "$ipums/clean/delta_ssi_noC.dta", keep(3) nogen

*merge in delta wage data
merge 1:1 occ2 using "$ipums/clean/delta_wage_noC.dta", keep(3) nogen

*merge in delta SSI recipients data
merge 1:1 occ2 using "$ipums/clean/delta_ssi_recipients_noC.dta", keep(3) nogen 
...
reg delta_ssi delta_wfh delta_wage delta_collects_SSI pct_change_ndis pct_change_ndis_sq, robust
estadd local controls Yes
...
*with controls + polynomial
reg delta_wfh dingel_wfh delta_wage delta_collects_SSI pct_change_ndis pct_change_ndis_sq, robust
